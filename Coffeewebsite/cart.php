...
if(isset($_POST['update_cart'])){
    ...
    if(isset($_POST['empty_cart'])){
        $varity_empty_item=$conn->prepare("SELECT * FROM `cart` WHERE user_id=?");
        $varity_empty_item->execute([$user_id]);

        if($varity_empty_item->rowCount()>0){
...
<head>
    ...
    <title>Coffee Website - wishlist page</title>
</head>
            ...
            <?php
               ...
               <form method="post" action="" class="box">
                ...
                <div class="flex">
                    ...
                    <button type="submit" name="update_cart" class="bx bx-edit fa-edit"></button>
                </div>
