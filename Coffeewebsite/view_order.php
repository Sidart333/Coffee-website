...
<head>
    ...
    <title>Coffee Website - order details page</title>
</head>
        ...
        <section class="orders-detail">
            <div class="box-container">
                <div class="title">
                    ...
                    <h1>order details</h1>
                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nam possimus tempore delectus officia nobis iure veritatis aliquid iusto, aspernatur similique. Tempore laborum fugit pariatur fuga earum magni, ipsum eius perferendis.10</p>
                    ...
                    if($select_orders->rowCount()>0){
                     ...
                     <div class="box">
                        <div class="col">
                            ...
                            <p class="price"><?= $fetch_product['price']; ?> x <?= $fetch_product['qty']; ?></p>
                        ...
                        <div class="col">
                            ...
                            <p class="user"><i class="bi bi-envelope"></i><?= $fetch_order['number']; ?></p>
                            <p class="user"><i class="bi bi-pin-map-fill"></i><?= $fetch_order['address']; ?></p>
                            <p class="title">status</p>
                            <p class="" style="color: <?php if ($fetch_order['status']=='delivered'){
                                echo 'green';}elseif ($fetch_order['status']== 'cancelled'){echo 'red';}else{echo 'orange';} ?>"><?= $fetch_order['status'] ?></p>
